module github.com/dceoy/gh-actions-for-devops/tools

go 1.26.0

tool (
	github.com/hairyhenderson/gomplate/v5/cmd/gomplate
...
require (
	...
	github.com/hairyhenderson/gomplate/v5 v5.1.0 // indirect
